  ...
  return (
    <div>
      <div className=" relative flex flex-col items-center ">
        ...
        />
        <div className="bg-custom-white rounded-3xl  w-5/6 absolute top-28 pb-6 lg:w-[585px] lg:h-[625px] lg:top-[195px]">
          <div className="flex-all-center">
            <h1 className=" w-full flex justify-center p-6 pt-8 font-Caveat text-4xl lg:text-5xl text-custom-blue-endGrad">
              Welcome vroomer !
            </h1>
            <div className="flex-all-center w-5/6 m-3 mb-8 lg:mb-12">
              ...
              <p className="text-4xl mb-2 font-Caveat  text-custom-blue-endGrad ">
                /
              </p>
              <p className="text-xs lg:text-base">
                <strong className="text-sm lg:text-xl">
            ...
            >
              ...
              />
              <p className="font-Caveat text-custom-white lg:text-3xl">
                I need <br />a car !
              </p>
            </div>
            <div
            ...
            >
              <div className="mix-blend-screen bg-custom-white rounded-full flex justify-around items-center p-1 w-full h-full">
                <Image
                  src="/logo/Icon-money.svg"
                  alt="logo de money"
                  width={0}
                  height={0}
                  className="w-16 h-14 lg:w-20 lg:h-[70px] "
                />
